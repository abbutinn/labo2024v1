...
###experimento7 aumento las iteraciones de la BO a param_local$bo_iteraciones -> 150  
#modificamos -> bagging_fraction = c(0.1, 0.9),
 ...
 #modificamos ->    is_unbalance = FALSE, #
...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/colaborativos/exp7/"
