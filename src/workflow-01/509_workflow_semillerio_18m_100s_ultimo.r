...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/semillero2/"
...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  #gustavo param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011)
  param_local$final_train <-  c(202107, 202106, 202105, 202104, 202103, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901) # c(202107, 202106, 202105) #Agu

 param_local$train$training <- c(202105, 202104, 202103, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901) #c(202105, 202104, 202103)

  ##Gustavo param_local$train$training <- c(202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009)
...
TS_strategy_baseline_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202105, 202104, 202103, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901) #c(202105, 202104, 202103)

  #param_local$train$training <- c(202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007)
  param_local$train$training <- c(202103, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901) #c(202103, 202102, 202101)
