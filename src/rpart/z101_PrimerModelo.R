...
modelo1 <- rpart(
  ...
  minsplit = 166, # minima cantidad de registros para que se haga el split
  minbucket = 324, # tamaño minimo de una hoja
  maxdepth = 6
) # profundidad maxima del arbol
...
# solo le envio estimulo a los registros
#  con probabilidad de BAJA+2 mayor  a  1/40
dapply[, Predicted_1 := as.numeric(prob_baja2_mod1 > 1 / 40)]
...
fwrite(dapply[, list(numero_de_cliente, Predicted_1)],
        file = "./exp/KA2001/K101_001_3.csv",
        sep = ","
)
